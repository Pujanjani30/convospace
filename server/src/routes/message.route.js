...
import { getMessages, updateUnSeenMessages, uploadMessageFile, getChannelMessages } from "../controllers/message.controller.js";
...
messageRoutes.get("/get-channel-messages", verifyToken, getChannelMessages);
